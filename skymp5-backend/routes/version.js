...
const LATEST_VERSION = '2.1.18'
const CLIENT_VERSION = '0.3.5'
const SERVER_VERSION = '0.3.1'
const DOWNLOAD_URL   = 'https://github.com/NatPiercii/DragonBreakOnline/releases/download/launcher-v2.1.18/DragonBreakLauncher.exe'

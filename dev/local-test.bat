@echo off
REM ============================================================================
REM  DragonBreak local dev test: offline server + Skyrim, no VPS / OAuth / backend.
REM
...
set "GAME_DIR=C:\DragonBreak\skyrim"
set "PROFILE_ID=1"
set "PORT=7777"
REM ----------------------------------------------------------------------------
...
start "DragonBreak Dev Server" cmd /k "cd /d "%SERVER_DIR%" && node dist_back\skymp5-server.js"
